...
#include <colorspace_fragment>
}`,Cl=`uniform vec4 texelSize;uniform float kernel;uniform float scale;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vec2 dUv=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;vUv0=vec2(uv.x-dUv.x,uv.y+dUv.y);vUv1=vec2(uv.x+dUv.x,uv.y+dUv.y);vUv2=vec2(uv.x+dUv.x,uv.y-dUv.y);vUv3=vec2(uv.x-dUv.x,uv.y-dUv.y);gl_Position=vec4(position.xy,1.0,1.0);}`,wl=[new Float32Array([0,0]),new Float32Array([0,1,1]),new Float32Array([0,1,1,2]),new Float32Array([0,1,2,2,3]),new Float32Array([0,1,2,3,4,4,5]),new Float32Array([0,1,2,3,4,5,7,8,9,10])],Tl=class extends Mi{constructor(e=new Qt){super({name:`KawaseBlurMaterial`,uniforms:{inputBuffer:new Y(null),texelSize:new Y(new Qt),scale:new Y(1),kernel:new Y(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Sl,vertexShader:Cl}),this.setTexelSize(e.x,e.y),this.kernelSize=xl.MEDIUM}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.inputBuffer=e}get kernelSequence(){return wl[this.kernelSize]}get scale(){return this.uniforms.scale.value}set scale(e){this.uniforms.scale.value=e}getScale(){return this.uniforms.scale.value}setScale(e){this.uniforms.scale.value=e}getKernel(){return null}get kernel(){return this.uniforms.kernel.value}set kernel(e){this.uniforms.kernel.value=e}setKernel(e){this.kernel=e}setTexelSize(e,t){this.uniforms.texelSize.value.set(e,t,e*.5,t*.5)}setSize(e,t){let n=1/e,r=1/t;this.uniforms.texelSize.value.set(n,r,n*.5,r*.5)}},El=class extends $c{constructor({kernelSize:e=xl.MEDIUM,resolutionScale:t=.5,width:n=_l.AUTO_SIZE,height:r=_l.AUTO_SIZE,resolutionX:i=n,resolutionY:a=r}={}){super(`KawaseBlurPass`),this.renderTargetA=new en(1,1,{depthBuffer:!1}),this.renderTargetA.texture.name=`Blur.Target.A`,this.renderTargetB=this.renderTargetA.clone(),this.renderTargetB.texture.name=`Blur.Target.B`;let o=this.resolution=new _l(this,i,a,t);o.addEventListener(`change`,e=>this.setSize(o.baseWidth,o.baseHeight)),this._blurMaterial=new Tl,this._blurMaterial.kernelSize=e,this.copyMaterial=new rl}getResolution(){return this.resolution}get blurMaterial(){return this._blurMaterial}set blurMaterial(e){this._blurMaterial=e}get dithering(){return this.copyMaterial.dithering}set dithering(e){this.copyMaterial.dithering=e}get kernelSize(){return this.blurMaterial.kernelSize}set kernelSize(e){this.blurMaterial.kernelSize=e}get width(){return this.resolution.width}set width(e){this.resolution.preferredWidth=e}get height(){return this.resolution.height}set height(e){this.resolution.preferredHeight=e}get scale(){return this.blurMaterial.scale}set scale(e){this.blurMaterial.scale=e}getScale(){return this.blurMaterial.scale}setScale(e){this.blurMaterial.scale=e}getKernelSize(){return this.kernelSize}setKernelSize(e){this.kernelSize=e}getResolutionScale(){return this.resolution.scale}setResolutionScale(e){this.resolution.scale=e}render(e,t,n,r,i){let a=this.scene,o=this.camera,s=this.renderTargetA,c=this.renderTargetB,l=this.blurMaterial,u=l.kernelSequence,d=t;this.fullscreenMaterial=l;for(let t=0,n=u.length;t<n;++t){let n=t&1?c:s;l.kernel=u[t],l.inputBuffer=d.texture,e.setRenderTarget(n),e.render(a,o),d=n}this.fullscreenMaterial=this.copyMaterial,this.copyMaterial.inputBuffer=d.texture,e.setRenderTarget(this.renderToScreen?null:n),e.render(a,o)}setSize(e,t){let n=this.resolution;n.setBaseSize(e,t);let r=n.width,i=n.height;this.renderTargetA.setSize(r,i),this.renderTargetB.setSize(r,i),this.blurMaterial.setSize(e,t)}initialize(e,t,n){n!==void 0&&(this.renderTargetA.texture.type=n,this.renderTargetB.texture.type=n,n===1009?e!==null&&e.outputColorSpace===`srgb`&&(this.renderTargetA.texture.colorSpace=We,this.renderTargetB.texture.colorSpace=We):(this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`,this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`))}static get AUTO_SIZE(){return _l.AUTO_SIZE}},Dl=`#include <common>
#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
...
#endif
}`,Ol=class extends Mi{constructor(e=!1,t=null){super({name:`LuminanceMaterial`,defines:{THREE_REVISION:`184`.replace(/\D+/g,``)},uniforms:{inputBuffer:new Y(null),threshold:new Y(0),smoothing:new Y(1),range:new Y(null)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Dl,vertexShader:nl}),this.colorOutput=e,this.luminanceRange=t}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get threshold(){return this.uniforms.threshold.value}set threshold(e){this.smoothing>0||e>0?this.defines.THRESHOLD=`1`:delete this.defines.THRESHOLD,this.uniforms.threshold.value=e}getThreshold(){return this.threshold}setThreshold(e){this.threshold=e}get smoothing(){return this.uniforms.smoothing.value}set smoothing(e){this.threshold>0||e>0?this.defines.THRESHOLD=`1`:delete this.defines.THRESHOLD,this.uniforms.smoothing.value=e}getSmoothingFactor(){return this.smoothing}setSmoothingFactor(e){this.smoothing=e}get useThreshold(){return this.threshold>0||this.smoothing>0}set useThreshold(e){}get colorOutput(){return this.defines.COLOR!==void 0}set colorOutput(e){e?this.defines.COLOR=`1`:delete this.defines.COLOR,this.needsUpdate=!0}isColorOutputEnabled(e){return this.colorOutput}setColorOutputEnabled(e){this.colorOutput=e}get useRange(){return this.luminanceRange!==null}set useRange(e){this.luminanceRange=null}get luminanceRange(){return this.uniforms.range.value}set luminanceRange(e){e===null?delete this.defines.RANGE:this.defines.RANGE=`1`,this.uniforms.range.value=e,this.needsUpdate=!0}getLuminanceRange(){return this.luminanceRange}setLuminanceRange(e){this.luminanceRange=e}},kl=class extends $c{constructor({renderTarget:e,luminanceRange:t,colorOutput:n,resolutionScale:r=1,width:i=_l.AUTO_SIZE,height:a=_l.AUTO_SIZE,resolutionX:o=i,resolutionY:s=a}={}){super(`LuminancePass`),this.fullscreenMaterial=new Ol(n,t),this.needsSwap=!1,this.renderTarget=e,this.renderTarget===void 0&&(this.renderTarget=new en(1,1,{depthBuffer:!1}),this.renderTarget.texture.name=`LuminancePass.Target`);let c=this.resolution=new _l(this,o,s,r);c.addEventListener(`change`,e=>this.setSize(c.baseWidth,c.baseHeight))}get texture(){return this.renderTarget.texture}getTexture(){return this.renderTarget.texture}getResolution(){return this.resolution}render(e,t,n,r,i){let a=this.fullscreenMaterial;a.inputBuffer=t.texture,e.setRenderTarget(this.renderToScreen?null:this.renderTarget),e.render(this.scene,this.camera)}setSize(e,t){let n=this.resolution;n.setBaseSize(e,t),this.renderTarget.setSize(n.width,n.height)}initialize(e,t,n){n!==void 0&&n!==1009&&(this.renderTarget.texture.type=n,this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}},Al=`#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`,jl=`uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}`,Ml=class extends Mi{constructor(){super({name:`DownsamplingMaterial`,uniforms:{inputBuffer:new Y(null),texelSize:new Y(new W)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Al,vertexShader:jl})}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setSize(e,t){this.uniforms.texelSize.value.set(1/e,1/t)}},Nl=`#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=Ue){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){switch(e.type){case`change`:this.recompile();break}}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),Jl(0,0,0,0),new Float32Array([0,0,0,0]),Jl(0,0,0,1),new Float32Array([0,0,0,1]),Jl(0,0,1,0),new Float32Array([0,0,1,0]),Jl(0,0,1,1),new Float32Array([0,0,1,1]),Jl(0,1,0,0),new Float32Array([0,1,0,0]),Jl(0,1,0,1),new Float32Array([0,1,0,1]),Jl(0,1,1,0),new Float32Array([0,1,1,0]),Jl(0,1,1,1),new Float32Array([0,1,1,1]),Jl(1,0,0,0),new Float32Array([1,0,0,0]),Jl(1,0,0,1),new Float32Array([1,0,0,1]),Jl(1,0,1,0),new Float32Array([1,0,1,0]),Jl(1,0,1,1),new Float32Array([1,0,1,1]),Jl(1,1,0,0),new Float32Array([1,1,0,0]),Jl(1,1,0,1),new Float32Array([1,1,0,1]),Jl(1,1,1,0),new Float32Array([1,1,1,0]),Jl(1,1,1,1),new Float32Array([1,1,1,1]);function ql(e,t,n){return e+(t-e)*n}function Jl(e,t,n,r){return ql(ql(e,t,.75),ql(n,r,.75),.875)}var Yl=`
uniform float uTime;
uniform float uAmp;
uniform float uFreq;
...
`;function eu(e,{tier:t=`full`}={}){let n=t===`full`,r;try{r=new Zc({canvas:e,antialias:n,alpha:!0,powerPreference:`high-performance`,failIfMajorPerformanceCaveat:!1})}catch(e){return console.warn(`[Brand-Alchemy] WebGL init failed; keeping static background.`,e),null}let i=n?2:1;r.setPixelRatio(Math.min(window.devicePixelRatio||1,i)),r.setSize(window.innerWidth,window.innerHeight),r.setClearAlpha(0),r.toneMapping=4,r.toneMappingExposure=1.05;let a=new Bn,o=new da(34,window.innerWidth/window.innerHeight,.1,100);o.position.set(0,0,3.6);let s=tu(),c=new ro(r),l=c.fromEquirectangular(s);a.environment=l.texture,s.dispose(),c.dispose();let u=new Si(1,n?64:32),d={uTime:{value:0},uAmp:{value:.18},uFreq:{value:1.3},uSpeed:{value:.2},uScroll:{value:0},uHover:{value:0},uColorA:{value:new J(16750899)},uColorB:{value:new J(53866)},uEmissive:{value:.3}},f=new Pi({color:10117922,metalness:1,roughness:.3,envMapIntensity:1.1,emissive:0});f.onBeforeCompile=e=>{for(let t in d)e.uniforms[t]=d[t];e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
`+Yl).replace(`#include <beginnormal_vertex>`,Xl).replace(`#include <begin_vertex>`,Zl),e.fragmentShader=e.fragmentShader.replace(`#include <common>`,`#include <common>
`+Ql).replace(`#include <emissivemap_fragment>`,`#include <emissivemap_fragment>
`+$l)};let p=new ri(u,f);a.add(p);let m=new ma(16773341,2.2);m.position.set(3,2.5,4);let h=new ma(8965375,.7);h.position.set(-4,-1,2);let g=new ma(53866,1.1);g.position.set(-2,3,-4),a.add(m,h,g),a.add(new ha(2105384,.6));let _=null;if(n){_=new dl(r),_.addPass(new zl(a,o));let e=new Rl({intensity:.32,luminanceThreshold:.85,luminanceSmoothing:.32,mipmapBlur:!0,kernelSize:xl.MEDIUM});_.addPass(new Kl(o,e))}function v(){let e=window.innerWidth,t=window.innerHeight,n=e/t;o.aspect=n,o.updateProjectionMatrix(),r.setSize(e,t),_&&_.setSize(e,t);let i=n>1?Pt.clamp((n-1)*1.15,0,1.7):0;p.position.x=i,o.position.z=n<.85?4.7:3.6}v();let y={x:0,y:0},b={x:0,y:0},x=0,S=0;function C(e){y.x=e.clientX/window.innerWidth*2-1,y.y=e.clientY/window.innerHeight*2-1,x=1}window.matchMedia(`(pointer: fine)`).matches&&window.addEventListener(`pointermove`,C,{passive:!0});let w=new Ma,T=0,E=!0;function D(){if(!E)return;T=requestAnimationFrame(D);let e=Math.min(w.getDelta(),.05);d.uTime.value+=e,b.x+=(y.x-b.x)*.045,b.y+=(y.y-b.y)*.045,d.uHover.value+=(x-d.uHover.value)*.05,d.uScroll.value+=(S-d.uScroll.value)*.08,x*=.96;let t=d.uScroll.value;p.rotation.y=0+d.uTime.value*.06+b.x*.35,p.rotation.x=-b.y*.28+t*.2,p.scale.setScalar(.78*(1-t*.28)),p.position.y=t*.9,f.opacity=1,f.envMapIntensity=1.15*(1-t*.5),_?_.render():r.render(a,o)}D();function ee(){v()}window.addEventListener(`resize`,ee,{passive:!0});function O(){document.hidden?(E=!1,cancelAnimationFrame(T)):E||(E=!0,w.getDelta(),D())}return document.addEventListener(`visibilitychange`,O),{setScroll(e){S=Pt.clamp(e,0,1)},setHover(e){x=Math.max(x,e)},destroy(){E=!1,cancelAnimationFrame(T),window.removeEventListener(`resize`,ee),window.removeEventListener(`pointermove`,C),document.removeEventListener(`visibilitychange`,O),u.dispose(),f.dispose(),l.dispose(),_&&_.dispose(),r.dispose()}}}function tu(){let e=document.createElement(`canvas`);e.width=512,e.height=256;let t=e.getContext(`2d`),n=t.createLinearGradient(0,0,0,256);n.addColorStop(0,`#ffd9a0`),n.addColorStop(.32,`#ff9933`),n.addColorStop(.55,`#0a0a0f`),n.addColorStop(.8,`#06241a`),n.addColorStop(1,`#00d26a`),t.fillStyle=n,t.fillRect(0,0,512,256),t.fillStyle=`rgba(255,255,255,0.9)`,t.beginPath(),t.ellipse(150,70,60,26,0,0,Math.PI*2),t.fill(),t.fillStyle=`rgba(255,210,150,0.7)`,t.beginPath(),t.ellipse(380,95,44,20,0,0,Math.PI*2),t.fill();let r=new gi(e);return r.mapping=303,r.colorSpace=We,r}export{eu as mountScene};