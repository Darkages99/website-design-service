...
import{t as e}from"./main-DEthd9Ok.js";import{D as t,S as n,_ as r,a as i,b as a,g as o,h as s,o as c,s as l,t as u,x as d,y as f}from"./three.module-BLkX8U5V.js";function p(i,{tier:a=`full`}={}){let p=a===`full`,h;try{h=new u({canvas:i,antialias:!1,alpha:!0,powerPreference:`high-performance`,failIfMajorPerformanceCaveat:!1})}catch(e){return console.warn(`[Brand-Alchemy] WebGL init failed; keeping static background.`,e),null}let g=p?2:1,_=Math.min(window.devicePixelRatio||1,g);h.setPixelRatio(_),h.setSize(window.innerWidth,window.innerHeight),h.setClearAlpha(0),h.toneMapping=4,h.toneMappingExposure=1;let v=new d;v.background=m();let y=new r(-1,1,1,-1,0,1),b={uTime:{value:0},uScroll:{value:0},uReaction:{value:0},uHover:{value:0},uMouse:{value:new t(.5,0)},uAspect:{value:window.innerWidth/Math.max(1,window.innerHeight)},uGold:{value:new l(16757084)},uGreen:{value:new l(2089098)},uCyan:{value:new l(3727871)},uDeep:{value:new l(463372)}},x=new n({uniforms:b,transparent:!0,depthWrite:!1,depthTest:!1,vertexShader:`
      varying vec2 vUv;
      void main(){
        vUv = uv;
