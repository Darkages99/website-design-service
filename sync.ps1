...
#
# BRANCH NOTE (chemistry-lab): this branch deploys to a SEPARATE theme folder
# `brand-alchemy-chem` so the original `brand-alchemy` theme in Studio stays untouched.
# Activate either theme in wp-admin to flip between the original and the chemistry look.

$src  = "E:\Website design service\brand-alchemy"
$dest = "C:\Users\SARANG RAJGOPAUL\Studio\brand-alchemyinfo\wp-content\themes\brand-alchemy-chem"
